...
const KO = {
  ...
  star: "★ 스타",
  startTitle: "내 초상 만들기",
  startLead: "GitHub 아이디를 넣거나, 이미지를 이 페이지 아무 곳에나 끌어다 놓으세요.",
  ghLabel: "GitHub 아이디",
  ghGo: "만들기",
  orFile: "또는",
  chooseFile: "이미지 고르기",
  stays: "· 기기 밖으로 나가지 않습니다",
  pickTitle: "명화로 시작해 보기",
  leaderA: "readme_portrait를 소개합니다",
  leaderB: "아바타 너머의 ASCII",
  headline: "당신의 얼굴을 README에 타이핑하다.",
