...
const KO = {
  ...
  pickTitle: "예시로 시작해 보기",
  gArt: "명화",
  gAnime: "애니풍",
  gSpace: "우주·풍경",
  headline: "당신의 얼굴을 README에 <span class=\"typed\">타이핑</span>하다.",
  galleryTitle: "명화, 애니풍, 우주. 한 점에 6,820글자.",
  galleryLead: "아래 카드는 모두 이 페이지가 퍼블릭 도메인 작품과 오리지널 일러스트로 실제로 만든 결과입니다. 한 장 한 장이 GitHub README 안에서 그대로 재생되는 SVG 파일입니다.",
  open: "열기",
  studioTitle: "스튜디오.",
