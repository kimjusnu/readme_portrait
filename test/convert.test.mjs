...
import {
  toLuma, equalize, resize, enhance, cropBox, crop, toCells, layoutFor, rgbaToRgb, DEFAULTS,
} from "../js/convert.js";
...
test("sample avatar: at least 90% of cells match the reference", () => {
